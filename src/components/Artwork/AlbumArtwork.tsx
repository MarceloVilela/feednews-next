    ...
    <div className={cn("space-y-3", className)} {...props}>
      <div className="overflow-hidden rounded-md">
        <img
          ...
          height={height}
          className={cn(
            "h-auto w-auto object-cover transition-all hover:scale-105 opacity-10",
      ...
      <div className="space-y-1 text-sm">
        ...
        <p className="text-xs text-muted-foreground overflow-hidden break-words hidden">{data.description}</p>
      </div>
    </div>
  );
}
