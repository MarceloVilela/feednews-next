...
class TechTudoJogos implements ISource {
  getOriginUrl(): string {
    return 'https://www.techtudo.com.br/jogos';
  }
  ...
  async getHome(): Promise<IResponseHomeDTO> {
    ...
    const postsData = [...document.querySelectorAll('.feed-post-body'),]
...
export default new TechTudoJogos();
