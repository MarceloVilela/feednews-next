...
class N1nt3 implements ISource {
  getOriginUrl(): string {
    return atob("aHR0cHM6Ly93d3cubmludGVuZG9ibGFzdC5jb20uYnIv");
  }
  ...
  async getHome(): Promise<IResponseHomeDTO> {
    ...
    const getContent = (elPost: Element) => {
      return {
        ...
        thumb:
          elPost.querySelector(".index-thumbnail")?.getAttribute("style") &&
          String(
            elPost.querySelector(".index-thumbnail")?.getAttribute("style"),
          ).split("(")[1]
            ? String(
